...
import { one,two,three,four,five,plus,minus,divided_by,times, seven, six } from '../Function/Code';
...
export default function Homepage() {
  ...
  useEffect(()=>{
    const response =axios.post('https://sprittle-assignment-server0.vercel.app/api/questions/',{
