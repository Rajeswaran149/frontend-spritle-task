...
export default function QuestionPage() {
  ...
  useEffect(() => {
    const response = axios
      .get("https://backend-spritle-task.vercel.app/api/students")
      .then((res) => {
  ...
  const handleAsk = () => {
    axios
      .post("https://sprittle-assignment-server0.vercel.app/api/question", {
  ...
  return (
    <div className="QuestionenterCon">
      <div className="questiondes">
        ...
        <span className="Quesiondotedes">
          Nice text goes here to explain the question creation part like never
          before
        </span>
      </div>
